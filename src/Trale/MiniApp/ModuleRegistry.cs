...
public static class ModuleRegistry
{
    private static readonly FrozenDictionary<string, ModuleDefinition> Modules = new Dictionary<string, ModuleDefinition>
    {
        ...
        ["verbal-aspect"] = new("verbal-aspect", "Lessons/GeorgianVerbalAspect", 1),
        ...
        ["present-tense"] = new("present-tense", "Lessons/GeorgianPresentTense", 7),
        ["cafe"] = new("cafe", "Lessons/GeorgianVocabCafe", 7),
        ["taxi"] = new("taxi", "Lessons/GeorgianVocabTaxi", 7),
