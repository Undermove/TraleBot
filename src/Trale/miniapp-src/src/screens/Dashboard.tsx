    ...
    <div className="flex flex-col min-h-full bg-cream">
      ...
      {(() => {
        const moduleIcons: Record<string, string> = {
          ...
          'aorist': 'მ', 'verbal-aspect': 'ვ', 'future-tense': 'ხ', 'pronoun-declension': 'ი', 'conditionals': 'თ',
          'imperative': 'ბ',
        ...
        const moduleGeoLabels: Record<string, string> = {
          ...
          'imperfect': 'უწყვეტელი', 'aorist': 'წყვეტილი', 'verbal-aspect': 'სახეობა', 'future-tense': 'მომავალი', 'pronoun-declension': 'ბრუნვა',
