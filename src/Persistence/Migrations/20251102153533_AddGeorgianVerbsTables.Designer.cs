...
namespace Persistence.Migrations
{
    ...
    [Migration("20251102153533_AddGeorgianVerbsTables")]
    partial class AddGeorgianVerbsTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.GeorgianVerb", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ExampleFuture")
                        .HasColumnType("text");

                    b.Property<string>("ExamplePast")
                        .HasColumnType("text");

                    b.Property<string>("ExamplePresent")
                        .HasColumnType("text");

                    b.Property<string>("Explanation")
                        .HasColumnType("text");

                    b.Property<string>("Georgian")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domain.Entities.StudentVerbProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("GeorgianVerbId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsMarkedAsHard")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.Property<Guid>("VerbCardId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("GeorgianVerbId");

                    b.HasIndex("LastReviewDateUtc");

                    b.HasIndex("VerbCardId");

                    b.HasIndex("UserId", "IsMarkedAsHard");

                    b.HasIndex("UserId", "NextReviewDateUtc");

                    b.ToTable("StudentVerbProgress");
                });
            ...
            modelBuilder.Entity("Domain.Entities.VerbCard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string[]>("IncorrectOptions")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<string>("QuestionGeorgian")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<int>("TimeFormId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("VerbId", "ExerciseType");
            ...
            modelBuilder.Entity("Domain.Entities.StudentVerbProgress", b =>
                {
                    b.HasOne("Domain.Entities.GeorgianVerb", null)
                        .WithMany("StudentProgress")
                        .HasForeignKey("GeorgianVerbId");
                    ...
                    b.HasOne("Domain.Entities.VerbCard", "VerbCard")
                        .WithMany()
                        .HasForeignKey("VerbCardId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("User");

                    b.Navigation("VerbCard");
                });
            ...
            modelBuilder.Entity("Domain.Entities.VerbCard", b =>
                {
                    b.HasOne("Domain.Entities.GeorgianVerb", "Verb")
                        .WithMany("Cards")
