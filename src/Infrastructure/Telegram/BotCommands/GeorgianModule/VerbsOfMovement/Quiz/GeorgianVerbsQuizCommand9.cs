...
public class GeorgianVerbsQuizCommand9 : IBotCommand
{
    ...
    public GeorgianVerbsQuizCommand9(
        ...
        IGeorgianQuestionsLoaderFactory loaderFactory)
    {
        ...
        _questionsLoader = loaderFactory.CreateForLesson(9);
    }

    public Task<bool> IsApplicable(TelegramRequest request, CancellationToken ct)
    {
        return Task.FromResult(
            request.Text.StartsWith(CommandNames.GeorgianVerbsQuizStart9, StringComparison.InvariantCultureIgnoreCase));
    }
