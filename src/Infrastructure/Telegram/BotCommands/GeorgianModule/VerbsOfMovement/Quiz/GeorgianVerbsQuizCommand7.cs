...
public class GeorgianVerbsQuizCommand7 : IBotCommand
{
    ...
    public GeorgianVerbsQuizCommand7(
        ...
        IGeorgianQuestionsLoaderFactory loaderFactory)
    {
        ...
        _questionsLoader = loaderFactory.CreateForLesson(7);
    }

    public Task<bool> IsApplicable(TelegramRequest request, CancellationToken ct)
    {
        return Task.FromResult(
            request.Text.StartsWith(CommandNames.GeorgianVerbsQuizStart7, StringComparison.InvariantCultureIgnoreCase));
    }
