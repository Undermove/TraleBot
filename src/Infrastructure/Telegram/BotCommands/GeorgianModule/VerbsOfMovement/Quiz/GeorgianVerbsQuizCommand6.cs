...
public class GeorgianVerbsQuizCommand6 : IBotCommand
{
    ...
    public GeorgianVerbsQuizCommand6(
        ...
        IGeorgianQuestionsLoaderFactory loaderFactory)
    {
        ...
        _questionsLoader = loaderFactory.CreateForLesson(6);
    }

    public Task<bool> IsApplicable(TelegramRequest request, CancellationToken ct)
    {
        return Task.FromResult(
            request.Text.StartsWith(CommandNames.GeorgianVerbsQuizStart6, StringComparison.InvariantCultureIgnoreCase));
    }
