...
public class GeorgianVerbsQuizCommand4 : IBotCommand
{
    ...
    public GeorgianVerbsQuizCommand4(
        ...
        IGeorgianQuestionsLoaderFactory loaderFactory)
    {
        ...
        _questionsLoader = loaderFactory.CreateForLesson(4);
    }

    public Task<bool> IsApplicable(TelegramRequest request, CancellationToken ct)
    {
        return Task.FromResult(
            request.Text.StartsWith(CommandNames.GeorgianVerbsQuizStart4, StringComparison.InvariantCultureIgnoreCase));
    }
