...
public class GeorgianVerbsQuizCommand5 : IBotCommand
{
    ...
    public GeorgianVerbsQuizCommand5(
        ...
        IGeorgianQuestionsLoaderFactory loaderFactory)
    {
        ...
        _questionsLoader = loaderFactory.CreateForLesson(5);
    }

    public Task<bool> IsApplicable(TelegramRequest request, CancellationToken ct)
    {
        return Task.FromResult(
            request.Text.StartsWith(CommandNames.GeorgianVerbsQuizStart5, StringComparison.InvariantCultureIgnoreCase));
    }
