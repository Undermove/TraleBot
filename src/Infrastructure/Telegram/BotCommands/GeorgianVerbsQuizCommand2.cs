...
public class GeorgianVerbsQuizCommand2 : IBotCommand
{
    ...
    public GeorgianVerbsQuizCommand2(
        ...
        IGeorgianQuestionsLoaderFactory loaderFactory)
    {
        ...
        _questionsLoader = loaderFactory.CreateForLesson(2);
    }

    public Task<bool> IsApplicable(TelegramRequest request, CancellationToken ct)
    {
        return Task.FromResult(
            request.Text.StartsWith(CommandNames.GeorgianVerbsQuizStart2, StringComparison.InvariantCultureIgnoreCase));
    }
